...
/* end of profile and popup modal*/
        .sidebar {
  width: 240px;
      ...
      `}
            ...
            <div className="main-content">
                ...
                <div className="metrics-grid">
                    ...
                    <div className="metric-card">
                        <div className="metric-label">Total Pickup Trash</div>
                        <div className="metric-value">3,298</div>
                    </div>
                    <div className="metric-card">
                        <div className="metric-label">Total Collection Points</div>
                        <div className="metric-value">10,689</div>
                    </div>
                </div>
                ...
                <div className="charts-grid">
                    ...
                    <div className="chart-card">
                        <h3 className="chart-title">Top Most Ordered Location Pickup</h3>
                        <div>
                ...
                <div className="calendar-card">
                    ...
                    <div className="calendar-grid">
                        ...
                        {calendarDays.map((day) => (
                            <div
                                key={`day-${day}`}
                                className={`calendar-day ${pickupDays.includes(day) ? 'pickup' : ''}`}
                            >
                                {day}
                            </div>
                        ))}
